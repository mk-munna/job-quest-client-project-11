        ...
        <div>
            ...
            <div className='max-w-[90%] mx-auto mt-10 space-y-8 lg:px-8 font-Montserrat'>
                ...
                <div className=' flex gap-4  lg:w-[900px]'>
                    ...
                    <div>
                        <h1 className='text-heading font-Montserrat dark:text-heading2 text-3xl font-semibold'>What is an access token and refresh token? How do they work and where should
                ...
                <div className=' flex gap-4  lg:w-[900px]'>
                    ...
                    <div>
                        <h1 className='text-heading font-Montserrat dark:text-heading2 text-3xl font-semibold'> What is express js? What is Nest JS?</h1>
                        <p className='mt-6'>
                ...
                <div className=' flex gap-4  lg:w-[900px]'>
                    ...
                    <div>
                        <h1 className='text-heading font-Montserrat dark:text-heading2 text-3xl font-semibold'> About my website features and code</h1>
                        <p className='mt-6'>
